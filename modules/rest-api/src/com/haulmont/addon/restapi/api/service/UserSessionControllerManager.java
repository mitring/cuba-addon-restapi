...
public class UserSessionControllerManager {
    ...
    public void setSessionLocaleToRequestLocale(HttpServletRequest request) {
        ...
        throw new RestAPIException("Could not change user session locale", null, HttpStatus.BAD_REQUEST);
    }
}
