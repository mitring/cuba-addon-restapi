...
import com.haulmont.addon.restapi.api.service.UserSessionControllerManager;
...
@RestController("restapi_UserSessionController")
...
public class UserSessionController {
    ...
    public void setSessionLocale(HttpServletRequest request) {
        localeControllerManager.setSessionLocaleToRequestLocale(request);
    }
}
